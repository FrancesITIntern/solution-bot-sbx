...
AIPROJECT_CONNECTION_STRING = os.getenv("swedencentral.api.azureml.ms;e4422155-d74d-49f4-aa08-ff6cf9bd2cf1;rg-data-analytics-ai-sandbox;AI-Chatbot")
AGENT_ID = os.getenv("asst_pzfAqvDfVIERyMm79bJNauKR")
